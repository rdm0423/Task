...
class TaskListTableViewController: UITableViewController {
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "toTaskSegue" {
            
            if let detailTableViewController = segue.destinationViewController as? TaskDetailTableViewController,
                let selectedIndex = tableView.indexPathForSelectedRow?.row {
                
                let task = TaskController.sharedController.tasks[selectedIndex]
                detailTableViewController.task = task
            }
        }
    }
}
